...
- [x] 02-03-PLAN.md — CpuBackend RandomForest slice: bootstrap + exact best-split, completing ET/RF × clf/reg (ENG-03)
...
| 3. Feature Quantizer (CPU/GPU Bit-Parity) | 0/3 | Not started | - |
